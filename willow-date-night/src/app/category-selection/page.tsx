      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 py-8">
        <div className="w-full max-w-6xl">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 max-w-5xl mx-auto">
            ...
            >
              <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-500/20 via-purple-500/20 to-pink-500/20 border-2 border-blue-400/30 backdrop-blur-md p-8 lg:p-12 h-full">
                {/* Background Effects */}
                ...
                <div className="relative z-10">
                  {/* Icon */}
                  <div className="w-20 h-20 bg-gradient-to-br from-blue-400 to-purple-500 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                    <UsersIcon className="w-10 h-10 text-white" />
                  </div>

                  {/* Title */}
                  <h2 className="font-craftwork-heavy text-3xl lg:text-4xl mb-4 text-high-contrast text-center">
                    Squad Vibes
                  </h2>
                  
                  {/* Subtitle */}
                  <p className="font-craftwork text-lg text-theme-secondary mb-6 text-center">
            ...
            >
              <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-red-500/20 via-pink-500/20 to-orange-500/20 border-2 border-red-400/30 backdrop-blur-md p-8 lg:p-12 h-full">
                {/* Background Effects */}
                ...
                <div className="relative z-10">
                  {/* Icon */}
                  <div className="w-20 h-20 bg-gradient-to-br from-red-400 to-pink-500 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
