    ...
    <div className="min-h-screen bg-theme text-theme-primary flex flex-col">
      ...
      <header className="flex justify-between items-center p-4 sm:p-6 border-b border-theme flex-shrink-0">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          {/* Category Badge - Show on mobile too */}
          {category && (
            <div className="flex items-center gap-2 bg-black bg-opacity-30 px-2 sm:px-3 py-1 sm:py-2 rounded-full">
              <span className="font-craftwork text-willow-green text-xs sm:text-sm">
                {category === 'squad' ? 'Squad' : 'Ride or Die'}
              </span>
            </div>
          )}
      ...
      <div className="flex-1 flex justify-center items-center px-4 sm:px-6 py-4">
        <div className="relative w-full max-w-6xl">
          ...
          <div className="block lg:hidden">
            {/* Game Cards - Mobile Centered with bottom padding for fixed meter */}
            <div className="flex justify-center mb-8 pb-24 md:pb-8">
            ...
            {/* Intimacy Meter - Now fixed at bottom via component */}
            <IntimacyMeter
              level={intimacyLevel}
